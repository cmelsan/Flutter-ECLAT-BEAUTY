import 'dart:io';
void main() {
  final file = File('lib/features/orders/domain/entities/order.dart');
  final content = '''
...
@freezed
abstract class OrderItem with _\ {
...
@freezed
abstract class OrderStatusHistory with _\ {
